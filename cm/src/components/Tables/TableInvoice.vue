...
const projects = [
  { id: 1, name: 'New Advertising Campaign', hours: '12.0', rate: '$75.00', price: '$900.00' },
   { id: 2, name: 'Dance', hours: '12.0', rate: '$75.00', price: '$900.00' },
    { id: 3, name: 'Jumping', hours: '12.0', rate: '$75.00', price: '$900.00' },
     { id: 4, name: 'Playing', hours: '12.0', rate: '$75.00', price: '$900.00' },
  // More projects...
]
